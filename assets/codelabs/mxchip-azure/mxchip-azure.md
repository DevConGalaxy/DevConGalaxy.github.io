...
Vous pouvez maintenant copier le code C# de [ce repository GitHub](https://github.com/cmaneu/DevRoadShow-IOT/tree/master/src/function) dans votre dossier de travail.
